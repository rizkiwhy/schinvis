                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            @if (Auth::user()->role_id === 1)
                                <form action="{{ route('admin.transaksi.permintaan.pengajuan.storepermintaan') }}"
                                    method="post" class="form-horizontal" id="form-tambah-pengajuan">
                                @elseif(Auth::user()->role_id === 2)
                                    <form action="{{ route('user.transaksi.permintaan.pengajuan.storepermintaan') }}"
                                        method="post" class="form-horizontal" id="form-tambah-pengajuan">
                                                ...
                                                @if ($item->statuspengajuan_id === 1)
                                                    @if (Auth::user()->role_id === 1)
                                                        <a class="btn btn-warning btn-sm"
                                                            href="{{ route('admin.transaksi.permintaan.pengajuan.editpermintaan', ['id' => $item->id]) }}"><i
                                                                class="fas fa-edit"></i></a>
                                                    @elseif (Auth::user()->role_id === 2)
                                                        <a class="btn btn-warning btn-sm"
                                                            href="{{ route('user.transaksi.permintaan.pengajuan.editpermintaan', ['id' => $item->id]) }}"><i
                                                                class="fas fa-edit"></i></a>
                                                    @elseif (Auth::user()->role_id === 3)
                                                        <a class="btn btn-warning btn-sm"
    ...
    <div class="modal fade" id="modal-delete-pengajuanbarang">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if (Auth::user()->role_id === 1)
                        <form action="{{ route('admin.transaksi.permintaan.pengajuan.destroypermintaan') }}"
