                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('admin.master.barang.subkelompok.store') }}" method="post"
                                class="form-horizontal" id="form-tambah-subkelompokbarang">
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Kode</label>
                                    <div class="input-group">
                                        <input type="text" name="kodekelompokbarang"
                                            class="form-control col-sm-2 text-center" style="text-transform: capitalize"
                                            id="kodekelompokbarang" disabled>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Kelompok Barang</label>
                                    <div class="input-group">
...
@section('main-content')
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data['subKelompokBarang'] as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->nama }}</td>
                                            <td>
                                                {{ $item->kelompokBarang->nama }}
                                            </td>
                                            <td class="text-center">
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ route('admin.master.barang.subkelompok.edit', ['id' => $item->id]) }}"><i
                                                        class="fas fa-edit"></i></a>
                                                <a class="btn btn-danger btn-sm"
                                                    onclick="deleteSubKelompokBarang({{ $item }})"
                                                    data-toggle="modal" data-target="#modal-delete-subkelompokbarang">
    ...
    <div class="modal fade" id="modal-delete-subkelompokbarang">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.master.barang.subkelompok.destroy') }}" method="post"
    ...
    <script>
        $('#form-tambah-subkelompokbarang').validate({
            rules: {
                nama: {
                    required: true,
                },
        ...
        function deleteSubKelompokBarang(arr) {
