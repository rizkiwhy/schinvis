...
@section('main-content')
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.master.barang.golongan.update') }}" method="post"
                                class="form-horizontal" id="form-edit-golonganbarang">
                                @csrf
                                <input type="hidden" id="id" name="id" value="{{ $data['golonganBarang']->id }}">
                                <div class="row">
                                    {{-- <div class="col-sm-6"> --}}
                                    ...
                                    <div class="input-group form-group">
                                        <div class="input-group">
                                            <input type="text" name="nama" class="form-control"
                                                ...
                                                value="{{ $data['golonganBarang']->nama }}">
    ...
    <script>
        $('#form-edit-golonganbarang').validate({
            rules: {
                nama: {
                    required: true,
                },
