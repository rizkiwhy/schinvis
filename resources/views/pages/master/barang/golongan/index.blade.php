                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('admin.master.barang.golongan.store') }}" method="post"
                                class="form-horizontal" id="form-tambah-golonganbarang">
                                @csrf
...
@section('main-content')
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @php
                                        $i = 1;
                                    @endphp
                                    @foreach ($data['golonganBarang'] as $item)
                                        <tr>
                                            <td class="text-center">{{ $i }}</td>
                                            <td>{{ $item->nama }}</td>
                                            <td class="text-center">
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ route('admin.master.barang.golongan.edit', ['id' => $item->id]) }}"><i
                                                        class="fas fa-edit"></i></a>
                                                <a class="btn btn-danger btn-sm"
                                                    onclick="deleteGolonganBarang({{ $item }})" data-toggle="modal"
                                                    data-target="#modal-delete-golonganbarang">
    ...
    <div class="modal fade" id="modal-delete-golonganbarang">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.master.barang.golongan.destroy') }}" method="post"
    ...
    <script>
        $('#form-tambah-golonganbarang').validate({
            rules: {
                nama: {
                    required: true,
                },
        ...
        function deleteGolonganBarang(arr) {
