                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('admin.master.title.store') }}" method="post" class="form-horizontal"
                                id="form-tambah-title">
                                @csrf
...
@section('main-content')
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ route('admin.master.title.edit', ['id' => $item->id]) }}"><i
                                                        class="fas fa-edit"></i></a>
                                                <a class="btn btn-danger btn-sm" onclick="deleteTitle({{ $item }})"
                                                    data-toggle="modal" data-target="#modal-delete-title">
    ...
    <div class="modal fade" id="modal-delete-title">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.master.title.destroy') }}" method="post" class="form-horizontal">
                        @csrf
