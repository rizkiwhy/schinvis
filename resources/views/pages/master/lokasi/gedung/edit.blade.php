            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.master.lokasi.gedung.update') }}" method="post"
                                class="form-horizontal" id="form-edit-gedung">
                                @csrf
                                <input type="hidden" id="id" name="id" value="{{ $data['gedung']->id }}">
                                <div class="row">
                                    <div class="col-sm-6">
