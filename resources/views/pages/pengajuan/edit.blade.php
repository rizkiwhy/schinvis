                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if (Auth::user()->role_id === 1)
                                <form action="{{ route('admin.pengajuan.update') }}" method="post" class="form-horizontal"
                                    id="form-edit-pengajuan">
                                @elseif (Auth::user()->role_id === 2)
                                    <form action="{{ route('user.pengajuan.update') }}" method="post"
                                        class="form-horizontal" id="form-edit-pengajuan">
                                    @elseif (Auth::user()->role_id === 3)
                                        <form action="{{ route('management.pengajuan.update') }}" method="post"
                                            class="form-horizontal" id="form-edit-pengajuan">
                            @endif
                            @csrf
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="estimasipenggunaan" class="form-control"
                                            ...
                                            value="{{ $data['pengajuanBarang']->estimasipenggunaan }}">
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control select2" id="jenispengajuanbarang_id"
                                            ...
                                            <option value="{{ $data['pengajuanBarang']->jenispengajuanbarang_id }}"
                                                disabled selected>
                                                {{ $data['pengajuanBarang']->jenisPengajuanBarang->nama }}</option>
                                            @foreach ($data['jenisPengajuanBarang']->except($data['pengajuanBarang']->jenispengajuanbarang_id) as $item)
                                    ...
                                    <div class="input-group">
                                        <select type="text" name="statuspengajuan_id" id="statuspengajuan_id"
                                            ...
                                            {{-- @foreach ($data['statusPengajuan']->except($data['pengajuanBarang']->statuspengajuan_id) as $item)
                                                <option value="{{ $item->id }}">
                                                    @if ($data['pengajuanBarang']->jenispengajuanbarang_id === 1 || $data['pengajuanBarang']->jenispengajuanbarang_id === 3)
                                                        {{ $item->namapengajuan }}
                                                    @elseif($data['pengajuanBarang']->jenispengajuanbarang_id === 2)
                                                        {{ $item->namapeminjaman }}
                                                    @endif
                                                </option>
                                            @endforeach --}}
