                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    <label for="exampleInputEmail1">Estimasi Peminjaman</label>
                                    <div class="input-group">
...
@section('main-content')
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data['pengajuanBarang'] as $item)
                                        <tr>
                                            ...
                                            <td>{{ ucwords($item->estimasipenggunaan . ' Hari') }}</td>
                                            <td>{{ ucwords($item->keterangan) }}</td>
                                            <td class="text-center align-top">
                                                @if ($item->statuspengajuan_id === 1)
                                                    @if (Auth::user()->role_id === 1)
                                                        <a class="btn btn-warning btn-sm"
                                                            href="{{ route('admin.gudang.peminjaman.pengajuan.edit', ['id' => $item->id]) }}"><i
                                                    ...
                                                    <a class="btn btn-danger btn-sm"
                                                        onclick="deletePengajuanPeminjamanBarang({{ $item }})"
                                                        data-toggle="modal"
    ...
    <script>
        $('#form-tambah-pengajuan-peminjaman').validate({
            rules: {
        ...
        function deletePengajuanPeminjamanBarang(arr) {
