...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-dark">ASSEK APP</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
                ...
                {{-- @if (Auth::user()->role_id === 2)
                    <li class="nav-item">
                        <a href="{{ route('user.pengajuan.index') }}" class="nav-link">
                            <i class="nav-icon fas fa-bell"></i>
                            <p>
                                Pengajuan
                            </p>
                ...
                <li class="nav-item">
                    @if (Auth::user()->role_id === 1)
                        <a href="{{ route('admin.alat-kerja.index') }}" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            @if (Auth::user()->role_id === 1)
                                <a href="{{ route('admin.transaksi.peminjaman.indexpribadi') }}" class="nav-link">
                                @elseif(Auth::user()->role_id === 2)
                        ...
                        <li class="nav-item">
                            @if (Auth::user()->role_id === 1)
                                <a href="{{ route('admin.transaksi.permintaan.index') }}" class="nav-link">
                                @elseif(Auth::user()->role_id === 2)
                        ...
                        <li class="nav-item">
                            @if (Auth::user()->role_id === 1)
                                <a href="{{ route('admin.transaksi.perbaikan.indexpribadi') }}" class="nav-link">
                                @elseif(Auth::user()->role_id === 2)
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.master.lokasi.gedung.index') }}" class="nav-link">
                                            <i class="far fa-building nav-icon"></i>
                                            <p>Gedung</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('admin.master.lokasi.ruangan.index') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.master.barang.golongan.index') }}" class="nav-link">
                                            <i class="far fa-dot-circle nav-icon"></i>
                                            <p>Golongan</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('admin.master.barang.bidang.index') }}" class="nav-link">
                                            <i class="far fa-dot-circle nav-icon"></i>
                                            <p>Bidang</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('admin.master.barang.kelompok.index') }}" class="nav-link">
                                            <i class="far fa-dot-circle nav-icon"></i>
                                            <p>Kelompok</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('admin.master.barang.subkelompok.index') }}"
                                            class="nav-link">
                                            <i class="far fa-dot-circle nav-icon"></i>
                                            <p>Sub Kelompok</p>
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('admin.master.barang.subsubkelompok.index') }}"
                                            class="nav-link">
                                            <i class="far fa-dot-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.master.title.index') }}" class="nav-link">
