...
<body class="hold-transition sidebar-mini layout-fixed layout-footer-fixed layout-navbar-fixed" oncontextmenu="return true;">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.get("/logout", function() {
                            ...
                            location.replace("http://11.11.11.4:8000/login")
                        }).then(() => {
